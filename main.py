...
def full_analysis():
    ...
    for lp, lpstr in zip(learn_percent, learning_percentage):
        ...
        for alg, wght in enumerate(pos, start=3):
            ...
            lstm2()
            prop_wout_optim()
            prop_wout_lowfeat(wght)
            prop_wout_highfeat(wght)
    ...
    for lpstr in learning_percentage:
        ...
        res = array(res)
        # clmn = ['Faster R-CNN [40]', 'gLSTM [34]', 'LSTM', 'DBN', 'BI-GRU', 'CNN+CMBO', 'CNN+SSA', 'CNN+WHO', 'CNN+SSO', 'CNN + SMO-SCME','LSTM']
        clmn = ['Faster R-CNN [40]', 'gLSTM [34]', 'LSTM', 'BI-GRU', 'CNN+CMBO', 'CNN+SSA', 'CNN+WHO', 'CNN+SSO', 'CNN + SMO-SCME','LSTM']
    ...
    column = ['Faster R-CNN [40]', 'gLSTM [34]', 'LSTM', 'BI-GRU', 'CNN+CMBO', 'CNN+SSA', 'CNN+WHO', 'CNN+SSO', 'CNN + SMO-SCME']
